...
void get_square_and_perimeter_by_convex_hull(point **array_of_points_in_convex_hull, int count_of_points_in_convex_hull, double *perimeter_out, double *square_out) {
    ...
    square = shoelace_summand(array_of_points_in_convex_hull[count_of_points_in_convex_hull-1], array_of_points_in_convex_hull[0]);
    ...
    for (i=1; i<count_of_points_in_convex_hull; i++) {
        ...
        square += shoelace_summand(array_of_points_in_convex_hull[i-1], array_of_points_in_convex_hull[i]);
    }

    (*perimeter_out) = perimeter;
    (*square_out) = fabs(square/2);
...
int main(void) {
    ...
    get_square_and_perimeter_by_convex_hull(array_of_points_in_convex_hull, count_of_points_in_convex_hull, &perimeter, &square);
